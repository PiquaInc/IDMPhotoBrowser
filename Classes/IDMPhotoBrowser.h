...
- (void)photoBrowser:(IDMPhotoBrowser *)photoBrowser didPressLeftToolbarButtonAtPhotoIndex:(NSUInteger)photoIndex;
...
@property (nonatomic, strong) UIImage *leftToolbarButtonImage;
